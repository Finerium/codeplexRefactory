...
> Authored by Athena (Refactor Mode) on 2026-05-12T14:57:19.393537+00:00. Folder A panitia-facing primary spec; mirror lives at `.agent-openspec/changes/add-2fa-to-login-67a53d/` for the internal workflow agent layer.
...
- The simulation engine writes ALL files under `drafts/add-2fa-to-login-67a53d/`; production code is untouched until the user clicks Accept at the dual review gate.
