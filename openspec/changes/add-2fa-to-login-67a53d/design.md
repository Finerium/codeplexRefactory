...
> Technical approach plus alternatives considered. Authored by Athena (Refactor Mode) on 2026-05-12T14:57:19.393537+00:00.
...
The simulation engine writes ONLY under `drafts/add-2fa-to-login-67a53d/`. The
