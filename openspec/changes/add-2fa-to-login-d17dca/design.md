...
> Technical approach plus alternatives considered. Authored by Athena (Refactor Mode) on 2026-05-12T20:21:36.135960+00:00.
...
The simulation engine writes ONLY under `drafts/add-2fa-to-login-d17dca/`. The
