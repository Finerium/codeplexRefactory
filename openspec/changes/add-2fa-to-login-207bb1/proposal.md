...
> Authored by Athena (Refactor Mode) on 2026-05-13T02:12:11.936092+00:00. Folder A panitia-facing primary spec; mirror lives at `.agent-openspec/changes/add-2fa-to-login-207bb1/` for the internal workflow agent layer.
...
- The simulation engine writes ALL files under `drafts/add-2fa-to-login-207bb1/`; production code is untouched until the user clicks Accept at the dual review gate.
