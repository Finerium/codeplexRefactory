...
> Authored by Athena (Refactor Mode) on 2026-05-13T02:13:03.393920+00:00. Folder A panitia-facing primary spec; mirror lives at `.agent-openspec/changes/add-2fa-to-login-013d07/` for the internal workflow agent layer.
...
- The simulation engine writes ALL files under `drafts/add-2fa-to-login-013d07/`; production code is untouched until the user clicks Accept at the dual review gate.
