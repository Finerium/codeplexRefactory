...
> Technical approach plus alternatives considered. Authored by Athena (Refactor Mode) on 2026-05-13T02:12:11.925085+00:00.
...
The simulation engine writes ONLY under `drafts/add-2fa-to-login-d45a09/`. The
