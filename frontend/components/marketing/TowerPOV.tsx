/**
 * TowerPOV, hero foreground frame.
 *
 * Authored by Calliope (Wave 1) ported 1-to-1 from Designer Prompt 1 bundle
 * file `app-tower.jsx`. Suggests the engineer-at-the-window POV (Direction
 * "Glass Tower at 3AM" picked by Ghaisan verbally per intent.md). The interior
 * is intentionally empty so the city outside is the protagonist.
 */
export function TowerPOV() {
  return (
