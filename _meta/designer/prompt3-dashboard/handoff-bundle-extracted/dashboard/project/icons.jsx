// Inline SVG icons. All stroke-based, currentColor, 16px default.
function Icon({ name, size = 16, ...rest }) {
  ...
  switch (name) {
    case 'chev-down':   return <svg {...common}><path d="M4 6l4 4 4-4" /></svg>;
    case 'chev-right':  return <svg {...common}><path d="M6 4l4 4-4 4" /></svg>;
    ...
    case 'arrow-flat':  return <svg {...common}><path d="M3 8h10M11 5l3 3-3 3" /></svg>;
    ...
    case 'github':      return <svg {...common} stroke="none" fill="currentColor"><path fillRule="evenodd" d="M8 1.3a6.7 6.7 0 0 0-2.12 13.06c.34.06.46-.15.46-.32v-1.1c-1.86.4-2.25-.9-2.25-.9-.3-.78-.74-.98-.74-.98-.6-.42.05-.4.05-.4.67.04 1.02.68 1.02.68.6 1.02 1.55.73 1.93.56.06-.44.23-.73.43-.9-1.5-.17-3.07-.74-3.07-3.3 0-.73.26-1.32.68-1.79-.07-.16-.3-.84.06-1.75 0 0 .56-.18 1.83.68a6.4 6.4 0 0 1 3.34 0c1.26-.86 1.82-.68 1.82-.68.36.91.13 1.59.06 1.75.43.47.68 1.06.68 1.79 0 2.57-1.57 3.13-3.07 3.3.24.2.45.6.45 1.22v1.82c0 .17.12.39.46.32A6.7 6.7 0 0 0 8 1.3z" /></svg>;
    case 'check':       return <svg {...common}><path d="M3 8l3 3 7-7" /></svg>;
    case 'eye':         return <svg {...common}><path d="M1.5 8s2.5-4.5 6.5-4.5S14.5 8 14.5 8 12 12.5 8 12.5 1.5 8 1.5 8z" /><circle cx="8" cy="8" r="2" /></svg>;
    case 'cube':        return <svg {...common}><path d="M8 1.8 2 4.6v6.8L8 14.2l6-2.8V4.6L8 1.8z" /><path d="M2 4.6 8 7.4l6-2.8M8 7.4v6.8" /></svg>;
    case 'argus':       return (
      <svg width={s} height={s} viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
        {/* simple watcher silhouette — triangle head + single pupil */}
