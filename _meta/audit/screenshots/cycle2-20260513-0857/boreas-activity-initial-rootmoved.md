    ...
    - main [ref=e3]:
      ...
      - status [ref=e392]:
        - generic [ref=e393]:
          ...
          - generic [ref=e395]: "Repository: gadablotnok/web-esp32log"
        - paragraph [ref=e396]: The repository URL is captured. The Wave 1 city render is the reference fastapi-style mock; the real per-repo materialization lands in Wave 3 via the Demeter parser + event store. The 50 to 300 file demo sweet spot per PRD Section 14.1 is enforced server-side when the backend is wired.
